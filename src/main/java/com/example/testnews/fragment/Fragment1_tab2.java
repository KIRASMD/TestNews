...
public class Fragment1_tab2 extends Fragment implements LoadListView.Listinterface,AdapterView.OnItemClickListener,LoadListView.RefreshListener{

    private LoadListView listView;
    private NewsAdapter adapter;
    public int currentPage=1;
    private List<News> listNews=new ArrayList<>();
    public int loadcode;//标记是下拉更新还是上拉载入


    String address="http://apis.baidu.com/txapi/world/world?num=15&page="+currentPage;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        listView = (LoadListView) view.findViewById(R.id.news_listview_2);
    ...
    public void onLoad() {
        ...
        address="http://apis.baidu.com/txapi/world/world?num=15&page="+currentPage;
        new AsyncTaskForNewsGet().execute(address);
    ...
    public void onRefresh() {
        loadcode=1;
        address="http://apis.baidu.com/txapi/world/world?num=15&page=1";
        new AsyncTaskForNewsGet().execute(address);
    }
    @Override
